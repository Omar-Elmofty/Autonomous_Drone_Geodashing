...
class PositionController(object):
    ...
    def __init__ (self):
		...
		#Define proportional gain for the z direction
		self.Kp_z = 10
		#Define proportional gain for psi angle
		self.Kp_psi = 10
